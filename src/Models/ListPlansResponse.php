...
class ListPlansResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the ListPlansResponse object to a human-readable string representation.
     *
     * @return string The string representation of the ListPlansResponse object.
     */
