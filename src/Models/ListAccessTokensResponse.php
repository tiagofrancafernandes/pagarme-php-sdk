...
class ListAccessTokensResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the ListAccessTokensResponse object to a human-readable string representation.
     *
     * @return string The string representation of the ListAccessTokensResponse object.
     */
