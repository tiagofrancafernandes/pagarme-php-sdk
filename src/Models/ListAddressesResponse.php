...
class ListAddressesResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the ListAddressesResponse object to a human-readable string representation.
     *
     * @return string The string representation of the ListAddressesResponse object.
     */
