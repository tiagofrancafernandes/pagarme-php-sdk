...
class ListRecipientResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the ListRecipientResponse object to a human-readable string representation.
     *
     * @return string The string representation of the ListRecipientResponse object.
     */
