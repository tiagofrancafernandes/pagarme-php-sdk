...
class ListPayablesResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the ListPayablesResponse object to a human-readable string representation.
     *
     * @return string The string representation of the ListPayablesResponse object.
     */
