...
class CreateSubscriptionSplitRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the CreateSubscriptionSplitRequest object to a human-readable string representation.
     *
     * @return string The string representation of the CreateSubscriptionSplitRequest object.
     */
