...
class ListChargeTransactionsResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the ListChargeTransactionsResponse object to a human-readable string representation.
     *
     * @return string The string representation of the ListChargeTransactionsResponse object.
     */
