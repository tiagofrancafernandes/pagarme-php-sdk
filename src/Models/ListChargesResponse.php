...
class ListChargesResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the ListChargesResponse object to a human-readable string representation.
     *
     * @return string The string representation of the ListChargesResponse object.
     */
